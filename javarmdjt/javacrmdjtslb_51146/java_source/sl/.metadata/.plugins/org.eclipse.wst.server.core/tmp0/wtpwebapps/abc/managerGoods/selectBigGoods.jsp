...
<table width="755" height="150%"  border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td height="847" class="linkBlack" bgcolor="#FFFFFF"><table width="100%" height="100%"  border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td width="26%" height="638" rowspan="3" valign="top" background="image/zuocedaohangbeijing.jpg">

		<jsp:include page="../left.jsp"/>


		</td>
        <td width="74%" height="46" align="center" valign="middle" background="../image/fl.jpg"><jsp:include page="../topThree.jsp"/></td>

      </tr>
      <tr>
        <td height="25" align="center" valign="middle" class="zi">
<%if(smallList.size()==0){%>目前该大商品类别没有设置商品的子类别<%}else{%>
...
<%if(bigList.size()==0){%><br><!--判断按小类别查询商品是否有数据-->
<br>
<br>
暂时没有商品的信息<br>
<br><br><br><%}else{%>
