 ...
 <jsp:include page="../upTwo.jsp"/>
  ...
  <tr>
	...
	<table width="99%" height="16"  border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td bgcolor="#E6E6E6"><div align="center"><font color="#990000"><b>添加网站信息</b></font></div></td>
      </tr>
    </table>
<br><br>
	

	  <form action="linkAction.do?action=2" method="post"  name="form" onSubmit="return checkEmpty(form)" >
