...
<%BigTypeForm form=(BigTypeForm)request.getAttribute("bigType");%>
<html>
<head>
 ...
 <jsp:include page="../upTwo.jsp"/>
  ...
  <tr>
	...
	<table width="99%" height="16"  border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td bgcolor="#E6E6E6"><div align="center" class="dhz"><font color="#990000"><b>修改商品大类别信息</b></font></div></td>
      </tr>
    </table>
<br><br>

	  <form action="bigTypeAction.do?action=5&id=<%=form.getId()%>" method="post"  name="form" onSubmit="return checkEmpty(form)" >
        <table width="90%" height="60"  border="1" cellpadding="0" cellspacing="0">
          <tr class="zi">
            <td width="25%" height="30"><div align="center">大类别名称</div></td>
            <td width="75%">&nbsp;&nbsp;&nbsp;&nbsp;<input name="name" type="text" size="50" value="<%=form.getBigName()%>"></td>
          </tr>
        </table>
        <p>
