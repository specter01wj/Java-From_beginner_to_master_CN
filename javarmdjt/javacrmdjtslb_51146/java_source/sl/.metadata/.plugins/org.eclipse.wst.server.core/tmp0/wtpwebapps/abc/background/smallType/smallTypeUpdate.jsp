...
<%SmallTypeForm small=(SmallTypeForm)request.getAttribute("small");%>
 ...
 <jsp:include page="../upTwo.jsp"/>
  ...
  <tr>
	...
	<table width="99%" height="16"  border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td bgcolor="#E6E6E6"><div align="center" class="dhz"><font color="#990000"><b>修改商品小类别信息</b></font></div></td>
      </tr>
    </table>
<br><br>
        ...
        <table width="90%" height="60"  border="1" cellpadding="0" cellspacing="0">
          <tr class="zi">
           ...
           <tr class="zi">
            ...
            <td width="75%">&nbsp;&nbsp;&nbsp;&nbsp;<input name="name" type="text" size="50" value="<%=small.getSmallName()%>"></td>
          </tr>
        </table>
        <p>
