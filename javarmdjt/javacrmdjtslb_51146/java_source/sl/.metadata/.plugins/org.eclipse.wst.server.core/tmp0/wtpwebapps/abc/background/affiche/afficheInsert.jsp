...
<table width="755"  border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
	...
	<table width="99%" height="16"  border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td bgcolor="#E6E6E6"><div align="center" class="dhz"><font color="#990000"><b>添加公告信息</b></font></div></td>
      </tr>
    </table>
<br><br>
	  ...
	  <form name="form" method="post" action="afficheAction.do?action=2" onSubmit="return checkEmpty(form)">
        <table width="90%" height="243"  border="1" cellpadding="0" cellspacing="0">
          <tr class="zi">
            ...
            <td width="77%">&nbsp;<input name="name" type="text" size="55"></td>
          </tr>
          <tr class="zi">
            <td height="208"><div align="center">公告内容</div>              </td>
            <td>&nbsp;&nbsp;
              <textarea name="content" cols="45" rows="13"></textarea></td>
          </tr>
        </table>
        <p>
